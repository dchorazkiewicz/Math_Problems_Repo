# Week 10 — Derivatives and Function Analysis: Problem 3

> **Problem source:** [`problem_set_10_derivatives_and_function_analysis.tex`](https://github.com/dchorazkiewicz/Lectures_notes_old_school/blob/main/mathematical_lectures/basic_mathematics/chapters/problem_sets/problem_set_10_derivatives_and_function_analysis.tex), Problem 3.  
> **Rule:** The statement is not stored in this template. Fill it only when you begin this problem.

## Problem statement

<!-- Read Problem Set 10, Problem 3 in the linked LaTeX source file. Copy only that statement here faithfully when you begin work. -->
...
[← Problem 2](problem_02.md) · [Problem 4 →](problem_04.md)
