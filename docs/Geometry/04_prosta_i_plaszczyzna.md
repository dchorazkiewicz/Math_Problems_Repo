...
2. $\star$ Oblicz odległość punktu $G(2,-1,0)$ od prostej przechodzącej przez punkty $H(0,0,0)$ i $I(1,1,1)$.

3. $\star$ Rozważ układ prostej i płaszczyzny zależny od parametru $\lambda$:
