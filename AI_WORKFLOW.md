...
Before starting a weekly problem set, read the corresponding PDF chapter. For the exact current problem statement, follow the week-to-LaTeX mapping in [`SOURCE_MATERIAL.md`](SOURCE_MATERIAL.md). Use the matching `problem_XX.md` file as the workspace for the solution.
