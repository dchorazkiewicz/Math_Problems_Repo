...
1. Share this document (`index.md`) with it.
2. Explain that the repository serves as a personal textbook and reasoning notebook.
3. Inform it that the tasks are meant to develop the analysis process, not just lead to a numerical result.
4. Emphasize that the exam takes place without technological support, so the goal of the work is the ability to independently reproduce solutions.
