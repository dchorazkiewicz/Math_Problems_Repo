...
> **Problem source:** [`calculus_problem_sets.tex`](https://github.com/dchorazkiewicz/Lectures_notes_old_school/blob/main/mathematical_lectures/basic_mathematics/chapters/problem_sets/calculus_problem_sets.tex), Problem Set 11, Problem 9.  
> **Rule:** The statement is not stored in this template. Fill it only when you begin this problem.

## Problem statement

<!-- Read Problem Set 11, Problem 9 in the linked LaTeX source file. Copy only that statement here faithfully when you begin work. -->
