# Week 5 — Vectors and Coordinates: Problem 14

> **Problem source:** [`problem_set_05_vectors_and_coordinates.tex`](https://github.com/dchorazkiewicz/Lectures_notes_old_school/blob/main/mathematical_lectures/basic_mathematics/chapters/problem_sets/problem_set_05_vectors_and_coordinates.tex), Problem 14.  
> **Rule:** The statement is not stored in this template. Fill it only when you begin this problem.

## Problem statement

<!-- Read Problem Set 5, Problem 14 in the linked LaTeX source file. Copy only that statement here faithfully when you begin work. -->
