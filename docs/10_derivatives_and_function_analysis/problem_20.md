...
> **Problem source:** [`problem_set_10_derivatives_and_function_analysis.tex`](https://github.com/dchorazkiewicz/Lectures_notes_old_school/blob/main/mathematical_lectures/basic_mathematics/chapters/problem_sets/problem_set_10_derivatives_and_function_analysis.tex), Problem 20.  
> **Rule:** The statement is not stored in this template. Fill it only when you begin this problem.

## Problem statement

<!-- Read Problem Set 10, Problem 20 in the linked LaTeX source file. Copy only that statement here faithfully when you begin work. -->
