# Week 9 — Limits and Continuity: Problem 1

> **Problem source:** [`problem_set_09_limits_and_continuity.tex`](https://github.com/dchorazkiewicz/Lectures_notes_old_school/blob/main/mathematical_lectures/basic_mathematics/chapters/problem_sets/problem_set_09_limits_and_continuity.tex), Problem 1.  
> **Rule:** The statement is not stored in this template. Fill it only when you begin this problem.

## Problem statement

<!-- Read Problem Set 9, Problem 1 in the linked LaTeX source file. Copy only that statement here faithfully when you begin work. -->
