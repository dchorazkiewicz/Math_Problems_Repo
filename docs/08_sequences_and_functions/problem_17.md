# Week 8 — Sequences and Functions: Problem 17

> **Problem source:** [`problem_set_08_sequences_and_functions.tex`](https://github.com/dchorazkiewicz/Lectures_notes_old_school/blob/main/mathematical_lectures/basic_mathematics/chapters/problem_sets/problem_set_08_sequences_and_functions.tex), Problem 17.  
> **Rule:** The statement is not stored in this template. Fill it only when you begin this problem.

## Problem statement

<!-- Read Problem Set 8, Problem 17 in the linked LaTeX source file. Copy only that statement here faithfully when you begin work. -->
...
[← Problem 16](problem_16.md) · [Problem 18 →](problem_18.md)
